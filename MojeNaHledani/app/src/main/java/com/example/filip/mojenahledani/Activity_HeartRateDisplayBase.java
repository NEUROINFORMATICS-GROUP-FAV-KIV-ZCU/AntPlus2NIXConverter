...
import com.example.filip.mojenahledani.MainActivity;
...
//        setContentView(R.layout.activity_heart_rate);
    ...
    protected void requestAccessToPcc() {
        ...
        if (intent.hasExtra(MainActivity.EXTRA_KEY_MULTIDEVICE_SEARCH_RESULT))
        {
            // device has already been selected through the multi-device search
            MultiDeviceSearch.MultiDeviceSearchResult result = intent
                    .getParcelableExtra(MainActivity.EXTRA_KEY_MULTIDEVICE_SEARCH_RESULT);
